                    ...
                    if(isset($_REQUEST['submit'])){
                        ...
                        echo '<!-- Row form Start -->
                            ...
                            <div class="row agenda">
                                <div class="col m12"><p class="warna agenda">Galeri file surat keluar antara tanggal <strong>'.indoDate($dari_tanggal).'</strong> sampai dengan tanggal <strong>'.indoDate($sampai_tanggal).'</strong></p>
                                </div>
                            </div>';
